    ...
    foreach ($levels as $lv) {
        ...
        if (!empty($sections)) {
            ...
            foreach ($sections as $sec) {
                ...
                echo '      <h3 class="section-title"><a href="' . asset($sectionPath) . '">' . e($sec['title_ru']) . '</a></h3>';
...
function render_header(string $title, bool $with_topbar = true): void {
    ...
    if ($with_topbar) {
        ...
        echo '<div class="header-title">'
           . '<span class="header-title--short">Искусство управления веб-страницей</span>'
           . '<span class="header-title--full">Искусство управления веб-страницей (Современный JavaScript DOM/BOM)</span>'
           . '</div>';
